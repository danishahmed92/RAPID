...
public class PatternGenerator {
    ...
    /**
     * Annotated document for which pattern will be generated
    ...
    /**
     *
     * @param sentence create annotation for sentence for which pattern will be generated
     */
     ...
     * @return list of all patterns that were generated by finding different distinct paths between subj and obj nodes
     */
    ...
    /**
     *
     * @param nonRootContainSubGraphs all semantic subgraphs that do not contain a child node C if it is a root node of another subgraph
    ...
    /**
     *
     * @param nonDupSGs distinct semantic subgraphs
     * @param subj subject label
     * @param obj object label
     * @return distinct semantic subgraphs which has replaced subject and object label with %D% and %R% respectively
     */
